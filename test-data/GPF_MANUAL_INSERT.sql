...
VALUES ('OFF001', 'Rajesh Kumar Singh', 'Pass@1234', TO_DATE('1980-05-15','YYYY-MM-DD'), 'OFFICER', SYSDATE);

INSERT INTO users (user_id, username, password, dob, work_status, last_password_change_date)
VALUES ('OFF002', 'Priya Sharma', 'Pass@1234', TO_DATE('1982-08-22','YYYY-MM-DD'), 'OFFICER', SYSDATE);

INSERT INTO users (user_id, username, password, dob, work_status, last_password_change_date)
VALUES ('IND001', 'Amit Patel', 'Pass@1234', TO_DATE('1985-03-10','YYYY-MM-DD'), 'INDUSTRIAL', SYSDATE);

INSERT INTO users (user_id, username, password, dob, work_status, last_password_change_date)
VALUES ('IND002', 'Neha Verma', 'Pass@1234', TO_DATE('1987-11-30','YYYY-MM-DD'), 'INDUSTRIAL', SYSDATE);

INSERT INTO users (user_id, username, password, dob, work_status, last_password_change_date)
VALUES ('NIN001', 'Vikram Desai', 'Pass@1234', TO_DATE('1988-07-18','YYYY-MM-DD'), 'NON_INDUSTRIAL', SYSDATE);

INSERT INTO users (user_id, username, password, dob, work_status, last_password_change_date)
VALUES ('NIN002', 'Anjali Gupta', 'Pass@1234', TO_DATE('1990-02-25','YYYY-MM-DD'), 'NON_INDUSTRIAL', SYSDATE);
...
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (101, 'OFF001-Y1', 5.5,  275000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (102, 'OFF001-Y2', 10.0, 550000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (103, 'OFF002-Y1', 6.0,  240000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (104, 'OFF002-Y2', 12.0, 480000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (105, 'IND001-Y1', 4.5,  135000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (106, 'IND001-Y2', 9.0,  270000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (107, 'IND002-Y1', 5.0,  120000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (108, 'IND002-Y2', 10.0, 240000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (109, 'NIN001-Y1', 3.5,  87500.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (110, 'NIN001-Y2', 7.0,  175000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (111, 'NIN002-Y1', 2.5,  50000.00);
INSERT INTO GPF_YEARS (ID, PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE) VALUES (112, 'NIN002-Y2', 5.0,  100000.00);
...
-- SELECT COUNT(*) FROM GPF_YEARS WHERE ID BETWEEN 101 AND 112;
