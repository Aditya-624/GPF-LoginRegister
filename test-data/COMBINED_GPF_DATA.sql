-- ============================================================================
-- COMBINED GPF DATA SCRIPT — Oracle SQL Developer
-- Run with F5 (Run Script) to execute all statements at once.
--
-- HOW TO USE:
--   OPTION A — Fresh / Empty Database:
--     Run SECTION 1 only (fresh inserts). Skip SECTION 2.
--
--   OPTION B — Existing Database with wrong/missing data:
--     Run SECTION 2 only (fix/patch). Skip SECTION 1.
--
--   OPTION C — Full reset (wipe + reload):
--     Uncomment the DELETE block at the top of SECTION 1, then run all.
--
-- LOGIN CREDENTIALS (React login form):
-- ┌──────────────────────────────────────────────────────────────────┐
...
-- ============================================================================
-- SECTION 1: FRESH INSERT (use on empty / newly created database)
-- ============================================================================

-- Optional: Uncomment below to wipe all data before re-inserting (full reset)
-- DELETE FROM GPF_SUB_DETAILS;
-- DELETE FROM GPF_SANCTION_DETAILS;
...
-- ----------------------------------------------------------------------------
-- 1C. GPF PURPOSE REFERENCE DATA (F and E)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 1D. GPF_YEARS (2 years per employee = 20 rows)
-- PASS_NUMBER = PERS_NUMBER (e.g. OFF001) — NOT the numeric account number
-- ID is GENERATED ALWAYS AS IDENTITY — do NOT insert ID manually
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 1E. GPF_USR_DETAILS — Applications (2 per employee = 20 rows)
-- PERSNO = users.id (1-10)
-- PURPOSE: 1=House Building, 2=Education, 3=Marriage, 4=Medical, 5=Vehicle
...
-- ----------------------------------------------------------------------------
-- 1F. GPF_SANCTION_DETAILS (2 per employee = 20 rows, ids 101-120)
-- ----------------------------------------------------------------------------
-- OFF001
...
-- ----------------------------------------------------------------------------
-- 1G. GPF_SUB_DETAILS — Monthly subscription records (Mar–Sep 2023)
...
-- ============================================================================
-- SECTION 2: FIX / PATCH (use on existing database with wrong or missing data)
-- ============================================================================

-- ----------------------------------------------------------------------------
-- 2A. Fix GPF_YEARS — delete wrong entries, re-insert correct ones
--     PASS_NUMBER must equal PERS_NUMBER (e.g. 'OFF001'), NOT 'OFF001-Y1' or '100001'
-- ----------------------------------------------------------------------------
...
DELETE FROM GPF_YEARS WHERE PASS_NUMBER IN ('OFF001','OFF002','OFF003','IND001','IND002','IND003','NIN001','NIN002','NIN003','NIN004');
...
-- ----------------------------------------------------------------------------
-- 2B. Fix GPF designations so work-status report filtering works
...
-- ----------------------------------------------------------------------------
-- 2C. Fix GPF_USR_DETAILS — wipe and re-insert correct purpose codes
--     PURPOSE: 1=House Building, 2=Education, 3=Marriage, 4=Medical, 5=Vehicle
-- ----------------------------------------------------------------------------
DELETE FROM GPF_USR_DETAILS;
...
-- ----------------------------------------------------------------------------
-- 2D. Add GPF_SUB_DETAILS for new employees if missing (safe idempotent inserts)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2E. Verify — should show 10 employees with year/closing balance filled
-- ----------------------------------------------------------------------------
