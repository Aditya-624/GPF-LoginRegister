...
SELECT 1,'OFF001','Rajesh Kumar Singh','Pass@1234',TO_DATE('1980-05-15','YYYY-MM-DD'),'OFFICER',SYSDATE
FROM dual WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 'OFF001');

INSERT INTO users (id, user_id, username, password, dob, work_status, last_password_change_date)
SELECT 2,'OFF002','Priya Sharma','Pass@1234',TO_DATE('1982-08-22','YYYY-MM-DD'),'OFFICER',SYSDATE
FROM dual WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 'OFF002');

INSERT INTO users (id, user_id, username, password, dob, work_status, last_password_change_date)
SELECT 3,'IND001','Amit Patel','Pass@1234',TO_DATE('1985-03-10','YYYY-MM-DD'),'INDUSTRIAL',SYSDATE
FROM dual WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 'IND001');

INSERT INTO users (id, user_id, username, password, dob, work_status, last_password_change_date)
SELECT 4,'IND002','Neha Verma','Pass@1234',TO_DATE('1987-11-30','YYYY-MM-DD'),'INDUSTRIAL',SYSDATE
FROM dual WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 'IND002');

INSERT INTO users (id, user_id, username, password, dob, work_status, last_password_change_date)
SELECT 5,'NIN001','Vikram Desai','Pass@1234',TO_DATE('1988-07-18','YYYY-MM-DD'),'NON_INDUSTRIAL',SYSDATE
FROM dual WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 'NIN001');

INSERT INTO users (id, user_id, username, password, dob, work_status, last_password_change_date)
SELECT 6,'NIN002','Anjali Gupta','Pass@1234',TO_DATE('1990-02-25','YYYY-MM-DD'),'NON_INDUSTRIAL',SYSDATE
...
-- Duplicate check uses PASS_NUMBER which has a UNIQUE constraint
-- ============================================================================

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'OFF001-Y1',5.5,275000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'OFF001-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'OFF001-Y2',10.0,550000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'OFF001-Y2');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'OFF002-Y1',6.0,240000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'OFF002-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'OFF002-Y2',12.0,480000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'OFF002-Y2');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'IND001-Y1',4.5,135000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'IND001-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'IND001-Y2',9.0,270000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'IND001-Y2');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'IND002-Y1',5.0,120000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'IND002-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'IND002-Y2',10.0,240000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'IND002-Y2');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'NIN001-Y1',3.5,87500.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'NIN001-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'NIN001-Y2',7.0,175000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'NIN001-Y2');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'NIN002-Y1',2.5,50000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'NIN002-Y1');

INSERT INTO GPF_YEARS (PASS_NUMBER, GPF_YEARS, CLOSING_BALANCE)
SELECT 'NIN002-Y2',5.0,100000.00 FROM dual WHERE NOT EXISTS (SELECT 1 FROM GPF_YEARS WHERE PASS_NUMBER = 'NIN002-Y2');
